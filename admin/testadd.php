...
{
extract($_POST);
mysqli_query($cn,"insert into mst_test(sub_id,test_name,total_que) values ('$subid','$testname','$totque')",$cn) or die(mysql_error());
...
<?php
$rs=mysqli_query($cn,"Select * from mst_subject order by  sub_name",$cn);
